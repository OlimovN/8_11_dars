    ...
    <div>
      <div className="text-[#fff]">
        ...
        <div className="flex flex-col gap-[32px]">
            <p className="font-[800] text-[18px] text-[#fbd784] px-[32px] py-[22px] border-[2px] border-[#fff]">—————————— A HIKG GUIDE</p>
            <h1 className="text-[80px] font-[600]">Be prepared for the Mountains and beyond!</h1>
            <button>scroll down ↓↷ↆ</button>
        </div>
        <div>
            <button className="border-r-[1px] text-[18px] font-[600] px-[32px] py-[22px] border-[2px] border-[#fff]">Start</button>
            <button  className="border-r-[1px] text-[18px] font-[600] px-[32px] py-[22px] border-[2px] border-[#fff]">01</button>
            <button  className="border-r-[1px] text-[18px] font-[600] px-[32px] py-[22px] border-[2px] border-[#fff]">02</button>
            <button  className="border-r-[1px] text-[18px] font-[600] px-[32px] py-[22px] border-[2px] border-[#fff]">03</button>
        </div>
      </div>
    </div>
  );
